...
The [issue tracker](https://github.com/dzungdinh94/ReactJS-Template.git/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git remote add upstream https://github.com/dzungdinh94/ReactJS-Template.git.git
    ```
...
owners to license your work under the terms of the [MIT License](https://github.com/dzungdinh94/ReactJS-Template.git/blob/master/LICENSE.md).
