...
**Note**: There's currently a [known problem](https://github.com/dzungdinh94/ReactJS-Template.git/pull/1698) with source maps and VS Code. You can change your Webpack dev config to use `inline-source-map` instead of `eval-source-map` and the issue should be resolved.
...
3.  Change WebPack devtool config to `source-map` [(This line)](https://github.com/dzungdinh94/ReactJS-Template.git/blob/56eb5a0ec4aa691169ef427f3a0122fde5a5aa24/internals/webpack/webpack.dev.babel.js#L65)
