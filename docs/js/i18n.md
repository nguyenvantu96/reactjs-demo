...
You will also notice a more complex use of `FormattedMessage` for the author message where alternate or variable values (i.e. `author: <A href="https://facebook.com/dung.dmr">Nguyen Dinh Dung</A>,`) are being injected, in this case it's a react component.
